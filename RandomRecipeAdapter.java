...
public class RandomRecipeAdapter extends RecyclerView.Adapter <RandomRecipeViewHolder>{
    ...
    holder.textView_service.setText(list.get(position).servings+"Servings");
...
class RandomRecipeViewHolder extends RecyclerView.ViewHolder{
    ...
    TextView textView_title, textView_service, textView_likes, textView_time;
    ...
    public RandomRecipeViewHolder(@NonNull View itemView){
        ...
        textView_service = itemView.findViewById(R.id.textView_service);
